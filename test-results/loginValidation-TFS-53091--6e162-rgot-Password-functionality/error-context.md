...
- Name: loginValidation.spec.ts >> TFS-53091 - Verify Forgot Password functionality
- Location: output\tests\loginValidation.spec.ts:6:5
...
Call log:
  - waiting for locator('#email-input') to be visible
