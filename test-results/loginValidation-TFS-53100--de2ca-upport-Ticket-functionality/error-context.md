...
- Name: loginValidation.spec.ts >> TFS-53100 - Verify Support Ticket functionality
- Location: output\tests\loginValidation.spec.ts:87:5
...
Call log:
  - waiting for locator('#support-message-input') to be visible
