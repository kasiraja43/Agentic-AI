...
- Name: loginValidation.spec.ts >> TFS-53097 - Verify Profile Management functionality
- Location: output\tests\loginValidation.spec.ts:60:5
...
Call log:
  - waiting for locator('#profile-username-input') to be visible
