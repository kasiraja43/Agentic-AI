...
- Name: loginValidation.spec.ts >> TFS-53095 - Verify Registration functionality
- Location: output\tests\loginValidation.spec.ts:42:5
...
Call log:
  - waiting for locator('#register-username-input') to be visible
