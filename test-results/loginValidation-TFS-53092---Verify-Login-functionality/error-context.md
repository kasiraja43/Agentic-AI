...
- Name: loginValidation.spec.ts >> TFS-53092 - Verify Login functionality
- Location: output\tests\loginValidation.spec.ts:15:5
...
Call log:
  - waiting for locator('#username-input') to be visible
