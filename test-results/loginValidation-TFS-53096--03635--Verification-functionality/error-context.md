...
- Name: loginValidation.spec.ts >> TFS-53096 - Verify Email Verification functionality
- Location: output\tests\loginValidation.spec.ts:51:5
...
Call log:
  - waiting for locator('#verification-code-input') to be visible
