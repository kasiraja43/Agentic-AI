...
- Name: loginValidation.spec.ts >> TFS-53093 - Verify Dashboard navigation
- Location: output\tests\loginValidation.spec.ts:24:5
...
Call log:
  - waiting for locator('.dashboard-title') to be visible
