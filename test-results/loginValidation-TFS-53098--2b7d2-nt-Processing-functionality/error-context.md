...
- Name: loginValidation.spec.ts >> TFS-53098 - Verify Payment Processing functionality
- Location: output\tests\loginValidation.spec.ts:69:5
...
Call log:
  - waiting for locator('#payment-amount-input') to be visible
